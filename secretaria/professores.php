            ...
            <table class="users" id="table-responsive" border="0">
                ...
                <tr>
                    ...
                    <td><h3><?php 
                        ...
                        <td></td>
                        <td>
                            <a class="a" href="professores.php?pg=todos&func=deleta&id=<?php echo $res_1['id_professores'];?>">
                            <img title="Excluir Professor" src="img/deleta.jpg" alt="" width="18" height="18" border="0">
                            </a>
                            <?php if($res_1['status']=='Inativo'){?>
                            <a class="a" href="professores.php?pg=todos&func=ativa&id=<?php echo $res_1['id_professores'];?>&code=<?php echo $res_1['code'];?>">
                            <img title="Ativar novamente professor" src="../image/correto.jpg" width="20" height="20" border="0" alt="">
                            </a>
                            <?php }?>
                            <?php if ($res_1['status']=='Ativo') {?>
                              ...
                              <img title="Inativar Professor(a)" src="../image/ico_bloqueado.png" width="18" height="18" border="0" alt=""></a>
                            <?php }?>
                            <a class="a" href="professores.php?pg=todos&func=edita&id=<?php echo $res_1['id_professores'];?>"><img title="Editar dados Cadastrais"
                             ...
                             <a class="a" rel="superbox[iframe][930x500]" href="historico_professor.php?id=<?php echo
                              $res_1['id_professores'];?>"><img title="Historico deste professor" src="../image/visualizar16.gif" 
...
$doutorado = $_POST['doutorado'];
$salario = $_POST['salario'];
$usuario=str_replace(' ','',$_POST['usuario']."@professor.ist");
