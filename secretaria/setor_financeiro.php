...
<table class="users" id="table-responsive"  border="0">
  <tr>
    <td colspan="4"><h3><strong>Relatório de hoje</strong></h3></td>
  </tr>
  <tr>
    <td ><strong>Mensalidades para hoje:</strong></td>
    <td ><strong>Mensalidades pagas hoje:</strong></td>
  ...
  <tr>
    ...
    <td>
	<?php $sql_8 = mysqli_query($conexao, "SELECT SUM(valor) as soma FROM mensalidades WHERE dia_pagamento = '$d/$m/$a' AND status = 'Pagamento Confirmado' AND (metodo_pagamento = 'Cheque' or metodo_pagamento='Depósito')");
  ...
  <tr>
    <td colspan="4"><h3><strong>Relatório deste mês</strong></h3></td>
  </tr>
  <tr>
    <td ><strong>Mensalidades do mês:</strong></td>
    <td ><strong>Mensalidades pagas neste mês:</strong></td>
    <td ><strong>Mensalidades que aguarda pagamento:</strong></td>
    <td ><strong>Valor:</strong></td>
  </tr>
  <tr>
    ...
    <td><?php echo $sql_3 = mysqli_num_rows(mysqli_query($conexao, "SELECT * FROM mensalidades WHERE mes = '$m' AND ano = '$a' AND status = 'Aguarda Pagamento'")); ?></td>
    <td>
    <?php
  ...
  <tr>
    ...
    <td>
	<?php $sql_8 = mysqli_query($conexao, "SELECT SUM(valor) as soma FROM mensalidades WHERE m_p = '$m' AND a_p = '$a' AND status = 'Pagamento Confirmado' AND (metodo_pagamento = 'Cheque' or metodo_pagamento='Depósito')");
  ...
  <tr>
    <td colspan="4"><h3><strong>Relatório do ano</strong></h3></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><?php echo $sql_3 = mysqli_num_rows(mysqli_query($conexao, "SELECT * FROM mensalidades WHERE ano = '$a' AND status = 'Aguarda Pagamento'")); ?></td>
    <td>
    <?php
  ...
  <tr>
    ...
    <td>
	<?php $sql_8 = mysqli_query($conexao, "SELECT SUM(valor) as soma FROM mensalidades WHERE a_p = '$a' AND status = 'Pagamento Confirmado' AND (metodo_pagamento = 'Cheque' or metodo_pagamento='Depósito')");
