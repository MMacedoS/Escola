...
$usuario = str_replace(' ','',$_POST['nome'])."@aluno.ist";
...
<?php if(isset($_POST['cancelar'])){?> 
    <script>window.location='estudantes.php?pg=todos';</script>
  <?php  }?>
...
<table class="users" id="table-responsive"  border="0">
    ...
    <tr>
	  ...
	  ?>  
        <option value="<?php echo $res_1['id_cursos']; ?>"><?php echo $res_1['curso'].' '.$res_1['turno']; ?></option>
      <?php } ?>
      </select>
      </td>
...
<table class="users" id="table-responsive"  border="0">
    ...
    <tr>
     <td></td>
      ...
      <td><input type="text" name="code" id="textfield" disabled="disabled" value="<?php echo $res_1['matricula']; ?>"></td>
    ...
    <tr>
      <td><input type="text" name="estado" id="textfield6" value="<?php echo $res_1['estado'];?>"></td>
      <td><input type="text" name="cidade" id="textfield7" value="<?php echo $res_1['cidade'];?>"></td>
      <td><input type="text" name="bairro" id="textfield8" value="<?php echo $res_1['bairro'];?>"></td>
    </tr>
    <tr>
      <td>Endereço:</td>
      <td>Complemento:</td>
    ...
    <tr>
      <td><input type="text" name="endereco" id="textfield8" value="<?php echo $res_1['endereco'];?>"></td>
      <td><input type="text" name="complemento" id="textfield8" value="<?php echo $res_1['complemento'];?>"></td>
...
<table class="users" id="table-responsive"  border="0">
    ...
    <tr>
      ...
      <?php $atua=$res_2['id_estudantes'];
        ...
        ?>
        <option value="<?php echo $cursosid; ?>"><?php echo $cursos.' | '.$res_buscacurso['turno'];?></option>
        <?php } ?>
      ...
      <td><label for="cuidado_especial"></label>
        <select name="cuidado_especial" size="1" id="cuidado_especial">
          <option value="<?php echo $res_2['atendimento_especial']; ?>"><?php echo $res_2['atendimento_especial']; ?></option>
          <option value="SIM">SIM</option>
          <option value="NÃO">NÃO</option>
      </select></td>
    </tr>
    ...
    <tr>
      <td><label for="mensalidade"></label>
      <input type="text" name="mensalidade" id="mensalidade" value="<?php echo $res_2['mensalidade'];?>"></td>
      <td><label for="vencimento"></label>
      <input type="text" name="vencimento" id="vencimento" value="<?php echo $res_2['vencimento'];?>"></td>
      <td><label for="tel_cobranca"></label>
      <input type="text" name="tel_cobranca" id="tel_cobranca" value="<?php echo $res_2['tel_cobranca'];?>"></td>
    </tr>
    <tr>
      <td>Observações para este(a) aluno(a)</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="3"><label for="obs"></label>
      <textarea name="obs" id="obs" cols="45" rows="5"> <?php echo $res_2['obs'];?></textarea></td>
    </tr>
    <tr>
      <td><input class="input" type="submit" name="button" id="button" value="Finalizar"></td>
      <td><button class="btn btn-danger"  name="cancelar" >Cancelar</button></td>
