...
responsável(eis) pelo(a) aluno(a): <b></b>  <u><?=$nome?></u>
                    ...
                    <div class="ass">
                        <div class="assinaturas">
                            <div id="container_ass_um" class="assinatura margin-right">
                                ...
                                <img src="../anexos/contrato/<?=$matricula?>_1.jpg" alt="Assinatura" width="100%" height="100%" >
                            ...
                            <div id="container_ass_dois" class="assinatura margin-left">
                                  <img src="../anexos/contrato/<?=$matricula?>_2.jpg" alt="Assinatura" width="100%" height="100%" >
                            </div>
                    ...
                    <div class="ass">
                        <div class="assinaturas">
                            <div id="container_ass_um" class="assinatura margin-right">
                                ...
                                <img src="../anexos/contrato/diretora1.jpg" alt="Assinatura" width="100%" height="100%" >
                            ...
                            <div id="container_ass_dois" class="assinatura margin-left">
                                  <img src="../anexos/contrato/diretora2.jpg" alt="Assinatura" width="100%" height="100%" >
                            </div>
                            <div class="preview" id="preview-dois">
                                <div class="close1" title="Alterar Imagem" onclick="resetImage('img_dois','container_ass_dois','preview-dois')">
                                    <span class="close">
