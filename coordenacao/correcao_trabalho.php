...
<table id="customers" border="0">
  ...
  <tr>
    ...
    <tr>
    <td colspan="1"><input type="submit" name="button" id="button" value="Inserir" onclick="alert('Nota Inserida')"></td>
    </tr>
    <?php }else{ while($res_4 = mysqli_fetch_assoc($result_4 )){ ?>
    <td><h3><?php echo $res_4['nota']; ?></h3></td>
    </tr>
    <tr>
   <td><a href="alterar_nota_trabalho.php?pg=coc&id=<?php echo $res_4['id_atividade'];?>&aluno=<?php echo $res_2['matricula']; ?>&disciplina=<?php echo $res_1['id_disciplina']; ?>&bimestre=<?php echo $res_1['bimestre'];  ?>&professor=<?php echo $res_1['professor'];  ?>&nota=<?php echo $res_4['nota']; ?>" rel="superbox[iframe][400x100]"><img src="../image/ico-editar.png" border="0" width="20" title="Alterar a nota" /></a></td>
   <!-- <td>&nbsp;</td>
   <td>&nbsp;</td> -->
   <td><a href="correcao_trabalho.php?pg=teste&id=<?php echo $id; ?>&selec=<?php echo $selec; ?>&idNota=<?php echo $res_4['id_notas_ava_coc'];?>&deleta=sim"><img src="../image/deleta.png" width="20" border="0" title="deleta nota" /></a></td>
...
switch ($bimestre) {
    ...
    }else
    {
      ...
      if(mysqli_num_rows($result_verifica)==0){
       $sql_3 = "INSERT INTO notas_ava_coc (code, bimestre, id_disciplina, nota, id_atividade,ano_letivo,prova) VALUES ('$code_aluno', '$bimestre', '$disciplina', '$nota', $id,'$date','Coordenador')";
...
<script>
var truncate = document.querySelectorAll(".diminuir");
