...
<?php $selec=@$_GET['selec']; ?>
    <div class="row col-sm-12 text-center d-flex justify-content-center">
        ...
        <div id="disciplina" class="row col-sm-6 mt-2 ml-2 mr-1">
...
<script>
    $('#filtro').click(function(event){
        ...
        var u_alunos=$('#alunos').val();      
        var u_ano=$('#ano').val();
        // console.log(u_bimestre,u_turma,u_alunos,u_situacao);
        if (u_alunos==='todos') {
            window.alert('carregando');
            window.location.assign("relatorio/boletim.php?turma="+u_turma+"&aluno="+u_alunos+"&ano="+u_ano);
        }else{
