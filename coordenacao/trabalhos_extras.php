...
<br /><a class="a3" rel="stylesheet" href="trabalhos_extras.php">Atualizar Pagina</a>
</div>
<p></p>
...
<table class="users" id="table-responsive" border="0">
  ...
  <tr>
    ...
    <td></td>
    <td><a href="trabalhos_extras.php?pg=excluir&id=<?php echo $res_1['id']; ?>&code=<?php echo $code; ?>"><img src="../image/deleta.png" width="22" border="0" /></a></td>
  </tr>  
  </table> 
<?php }} ?> 
