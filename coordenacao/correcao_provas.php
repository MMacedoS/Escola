...
$busca_prova="SELECT id_disciplina from avaliacao_prova where id_ava_prova='$id'";
...
<br>
<h1><a class="a3" rel="stylesheet" href="correcao_provas.php?pg=provas&selec=<?php echo $selec; ?>&selec=<?php echo $selec; ?>&id=<?php echo $id; ?>">Atualizar Pagina</a></h1>
<br>
 <h1>Abaixo, segue os alunos desta disciplina:  <?php echo $disc."  ".$curso;?>.       <h1>Lançar as nota da 4ª Ava:</h1></h1>

 
<?php

$sql_1 = "SELECT * FROM avaliacao_prova WHERE id_ava_prova= '$id'";
...
<table id="customers" border="0">
  ...
  <tr>
    ...
    <?php
    $sql_4 = "SELECT * FROM notas_ava_prova WHERE code = '$code_aluno' AND bimestre = '$bimestre' and id_atividade='$id'";
    ...
    <tr>
   <td><a href="alterar_nota_trabalho.php?pg=provas&id=<?php echo $res_4['id_atividade'];?>&aluno=<?php echo $res_2['matricula']; ?>&disciplina=<?php echo $res_1['id_disciplina']; ?>&bimestre=<?php echo $res_1['bimestre'];  ?>&professor=<?php echo $res_1['professor'];  ?>&nota=<?php echo $res_4['nota']; ?>" rel="superbox[iframe][400x100]"><img src="../image/ico-editar.png" border="0" width="30" title="Alterar a nota" /></a></td>
   
   <td><a href="correcao_provas.php?pg=provas&id=<?php echo $id; ?>&selec=<?php echo $selec; ?>&idNota=<?php echo $res_4['id_notas_ava_prova'];?>&deleta=sim"><img src="../image/deleta.png" width="30" border="0" title="deleta nota" /></a></td>
...
}else
{
  ...
  if(mysqli_num_rows($result_verifica)==0){
    ...
    $sql_3 = "INSERT INTO notas_ava_prova (code, bimestre, id_disciplina, nota, id_atividade,ano_letivo,prova) VALUES ('$code_aluno', '$bimestre', '$disciplina', '$nota', $id,'$date','Coordenador')";
