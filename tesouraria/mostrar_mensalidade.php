...
<div id="box">
<h1>Resumo da cobrança de <?php  $mensalidade = $_GET['mensalidade']; echo $_GET['nome'];?></h1>
<?php

$sql_1 = "SELECT * FROM mensalidades WHERE matricula = '$mensalidade'";
$result_1 = mysqli_query($conexao, $sql_1);
while($res_1 = mysqli_fetch_assoc($result_1)){
	$matricula =  $res_1['matricula'];

$sql_2 = "SELECT * FROM estudantes WHERE matricula = '$mensalidade'";	
...
?>
 <table class="users" id="table-responsive" border="0">
  ...
  <tr>
    <td colspan="4">| <a rel="superbox[iframe][270x180]" href="mostrar_mensalidade.php?mensalidade=<?php echo $res_1['code'];; ?>&status=baixa_mensalidade&valor=<?php echo $res_1['valor']; ?>&matricula=<?php echo $matricula; ?>">Informar pagamento</a> | <a rel="superbox[iframe][270x180]" href="mostrar_mensalidade.php?mensalidade=<?php echo $res_1['code']; ?>&status=reajustar_mensalidade&valor=<?php echo $res_1['valor']; ?>">Reajustar valor de cobrança</a> | </td>
  </tr>  
  <?php } ?>
</table>
<?php }} ?>
...
$sql_2 = "INSERT INTO fluxo_de_caixa (status, tipo, d, m, a, date_completo, date, codigo, descricao, valor, form_pag) VALUES ('Ativo', 'CRÉDITO', '$d', '$m', '$a', '$date', '$dia', '$mensalidade', 'Mensalidade do aluno: $matricula Competencia: $m/$a', '$valor', '$forma_de_pagamento')";
