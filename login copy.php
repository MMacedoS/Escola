...
<head>
    ...
    <link rel="shortcut icon" href="sistemaCopia/image/logo_ist.gif">
...
<div id="caixa_login">
    ...
    <form name="form" action="autenticar.php" method="post">
        ...
        <tr>
        <td><input class="input"type="submit" name="button" value="Entrar"><a class="input ml-2" id="retornar" href="index.php">Cancelar</a><p align="right"><a data-toggle="modal" data-target="#modal-senha" href="#">Esqueceu a senha? Recupere já!</a></p></td>
