...
<div id="box">
<?php if($_GET['pg'] == 'observacoes'){ ?>
<div class="row" id="row_button">
<br /><a class="a2" rel="superbox[iframe][850x350]" href="cadastrar_observacao.php?tipo=atividade_pesquisa&code=<?php echo $code; ?>">Cadastrar Pesquisa</a>
<br /><a class="a3" rel="stylesheet" href="todas_as_observacoes.php?pg=observacoes">Atualizar Pagina</a>
</div>
<p></p>
...
<?php
$sql_1 = "SELECT * FROM atividade_complementar WHERE professor = '$code' ORDER BY id DESC";
$result = mysqli_query($conexao, $sql_1);
if(mysqli_num_rows($result) == ''){
	 echo "<h2>No momento não existe nenhuma nota observação lançada no sistema!</h2>";	 
}else{
...
$sql_2 = "DELETE FROM atividade_complementar WHERE id = '$id'";
mysqli_query($conexao, $sql_2);

echo "<script language='javascript'>window.location='todas_as_observacoes.php?pg=observacoes';</script>";
