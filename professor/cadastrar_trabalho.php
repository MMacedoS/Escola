...
$sql_3 = "INSERT INTO atividades_pesquisa (date, status, professor, curso, disciplina, detalhes, bimestre, data_aplicacao) VALUES ('$date', 'Ativo', '$code', '$curso', '$dis', '$detalhes', '$bimestre', '$aplicacao')";
mysqli_query($conexao, $sql_3);
		
$sql_4 = "INSERT INTO mural_aluno (date, status, curso, titulo,origem) VALUES ('$date', 'Ativo', '$curso', 'As notas das pesquisas bimestrais estão sendo divulgadas','Minhas Notas')";
