...
<div id="box">
 <h1>Abaixo segue a lista dos alunos que enviaram o trabalho: <strong><?php echo $tema;?> </strong>-- disciplina:<strong> <?php echo $dis;?></strong> </h1>
...
echo "<script language='javascript'>window.location='alunos_que_mostraram_este_trabalho.php?id=$id_t&pg=trabalhos_bimestrais&tema=$tema&dis=$dis';</script>";
