...
<?php require "../config.php"; $id = $_GET['id']; $code = $_GET['code']; ?>
...
echo "<br><br><br>Este trabalho foi atualizado no sistema com sucesso!<br>clique no botão verde  e Aparte em F5 em seu teclado.";
...
<table width="700" border="0">
  ...
  <td>
      ...
      <option value="<?php echo $res_1['bimestre'];?>"><?php echo $res_1['bimestre'];?></option>
      </select></td>
