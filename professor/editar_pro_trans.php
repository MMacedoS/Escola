...
$sql_5 = "SELECT * FROM projetos_transversal WHERE id_pro_transversal = '$id'";
...
$sql_3 = "UPDATE projetos_transversal SET id_curso='$curso',id_disciplina = '$dis', detalhes = '$detalhes', bimestre = '$bimestre', data_aplicacao = '$aplicacao' WHERE id_pro_transversal = '$id' ";
mysqli_query($conexao, $sql_3);
$sql_4 = "UPDATE mural_aluno (date, curso, titulo,origem) VALUES ('$date','$curso', 'As notas das Projeto Transversal estão sendo divulgadas','Projetos')";
