...
$sql_5 = "SELECT * FROM projetos_interdisciplinar WHERE id_pro_inter = '$id'";
...
$sql_3 = "UPDATE projetos_interdisciplinar SET id_curso='$curso',id_disciplina = '$dis', detalhes = '$detalhes', bimestre = '$bimestre', data_aplicacao = '$aplicacao' WHERE id_pro_inter = '$id' ";
mysqli_query($conexao, $sql_3);
$sql_4 = "UPDATE mural_aluno (date, curso, titulo,origem) VALUES ('$date','$curso', 'As notas das Projetos Interdisciplinares estão sendo divulgadas','Projetos')";
