...
<div id="box">
<?php if($_GET['tipo'] == 'atividade_pesquisa'){ ?>
...
$sql_3 = "INSERT INTO atividade_complementar (date, status, professor, curso, disciplina, detalhes, bimestre, data_aplicacao) VALUES ('$date', 'Ativo', '$code', '$curso', '$dis', '$detalhes', '$bimestre', '$aplicacao')";
mysqli_query($conexao, $sql_3);
		
$sql_4 = "INSERT INTO mural_aluno (date, status, curso, titulo,origem) VALUES ('$date', 'Ativo', '$curso', 'As notas das notas Complementares estão sendo divulgadas','Minhas Notas')";
mysqli_query($conexao, $sql_4);

echo "<script language='javascript'>window.alert('atividade cadastrada com sucesso! Click em OK para cadastrar outras!');window.location='cadastrar_trabalho.php?tipo=atividade_pesquisa';</script>";
...
<table border="0">
  <tr>
    ...
    <td>Bimestre:</td>
    <td width="216">Data de entrega da pesquisa</td>
  </tr>
  <tr>
    <td>
