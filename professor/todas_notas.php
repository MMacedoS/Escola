...
<table id="customers" border="0">
  ...
  <tr>
    ...
    ?></h3></td>
    <td colspan="3"><a href="lancar_notas.php?pg=notas&selec=<?php echo $_GET['selec']; ?>&id=<?php echo $res_1['id_disciplinas']; ?>"><font color="blue">lançar nota de apredizagem</font></a></td>
