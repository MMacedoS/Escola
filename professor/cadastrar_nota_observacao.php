...
<?php require "../control/conexao.php"; $code = $_GET['code'];?>
</head>
...
$sql_4 = "INSERT INTO mural_aluno (date, status, curso, titulo, origem) VALUES ('$date', 'Ativo', '$curso', 'As notas bimestrais foram lançadas no sistema','notas_obs')";
