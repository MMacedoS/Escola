...
$verifica_busca="SELECT * FROM atividades_bimestrais where id_disciplina='$dis' and professor='$code' and id_curso='$curso' and bimestre='$bimestre' and ano_letivo='$ano_letivo'";
