...
$id = $_GET['id'];
$busca_prova="select disciplina from atividades_pesquisa where id='$id'";
...
<div id="box">
<br>
<h1><a class="a3" rel="stylesheet" href="correcao_trabalho.php?pg=atividade_pesquisa&id=<?php echo $id; ?>">Atualizar Pagina</a></h1>
<br>
...
$id = $_GET['id'];
$sql_1 = "SELECT * FROM atividades_pesquisa WHERE id = '$id'";
...
<table width="955" border="0">
  ...
  <tr>
    ...
    <?php
    $sql_4 = "SELECT * FROM notas_trabalhos WHERE code = '$code_aluno' AND bimestre = '$bimestre' and id_trabalho='$id'";
...
$disciplina = $_POST['disciplina'];
 ...
 $sql_3 = "INSERT INTO notas_trabalhos (code, bimestre, disciplina, nota, id_trabalho) VALUES ('$code_aluno', '$bimestre', '$disciplina', '$nota', '$id')";
 mysqli_query($conexao, $sql_3);
 
 
 
 echo "<script language='javascript'>window.location='correcao_trabalho.php?pg=atividade_pesquisa&id=$id';</script>";
