...
$sql_5 = "SELECT * FROM avaliacao_coc WHERE id_ava_coc = '$id'";
...
$sql_3 = "UPDATE avaliacao_coc SET id_curso='$curso',id_disciplina = '$dis', detalhes = '$detalhes', bimestre = '$bimestre', data_aplicacao = '$aplicacao' WHERE id_ava_coc = '$id' ";
mysqli_query($conexao, $sql_3);
$sql_4 = "UPDATE mural_aluno (date, curso, titulo,origem) VALUES ('$date','$curso', 'As notas das Avaliação COC estão sendo divulgadas','COC')";
