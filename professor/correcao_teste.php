...
<br>
 <h1>Abaixo segue a lista dos alunos desta disciplina:  <?php echo $disc."  ".$curso;?>.        <h1>LANÇAR NOTA DO TESTE:</h1></h1>
...
if(file_exists("../trabalhos_alunos/$prova")){
 ...
 $sql_3 = "INSERT INTO notas_ava_teste (code, bimestre, id_disciplina, nota, id_atividade,prova,ano_letivo) VALUES ('$code_aluno', '$bimestre', '$disciplina', '$nota', $id,'$prova','$date')";
