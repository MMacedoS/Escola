...
require_once  '../../Control/conexao.php';
    ...
    $sql_2=$pdo->query("SELECT r.media,r.id_resultado as id,r.id_disciplinas,e.nome as aluno,r.code as matricula,l.nome as disciplina,c.curso,r.situacao,r.recuperacao from resultado_final r inner join estudantes e on e.matricula=r.code  inner join disciplinas d on d.id_disciplinas=r.id_disciplinas inner join lista_disc l on l.id_lista=d.disciplina inner join cursos c on c.id_cursos=d.id_cursos inner join professores p on p.id_professores=d.id_professores where p.code=".@$_GET['professor']." and r.media<'27.6' order by c.ordem asc");  
  ...
  $pagina.='
    ...
    <table id="customers" border="0">
      ...
      if($total1==0){
        ...
        $pagina.='<td><input class="nota" name="nota" type="text" id="nota'.$numero.'" size="3" value=""></td>';
        }else{ 
