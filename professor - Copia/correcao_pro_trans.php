...
$idnota=$_GET['idNota'];
$deleta_nota="DELETE FROM notas_pro_transversal where id_notas_pro_transversal='$idnota'";
$deleta_nota=mysqli_query($conexao,$deleta_nota);
if($deleta_nota){
 echo "<script language='javascript'>window.location='correcao_pro_trans.php?pg=trans&selec=$selec&id=$id';</script>";
...
<br>
 <h1>Abaixo, segue os alunos desta disciplina:  <?php echo $disc."  ".$curso;?>.       <h1>Lançar notas do Projetos Transversais:</h1></h1>
...
<table class="users" id="table-responsive" border="0">
  ...
  <tr>
   ...
   <td>&nbsp;</td>
   <td>&nbsp;</td>
   <td><a href="correcao_pro_trans.php?pg=trans&id=<?php echo $id; ?>&selec=<?php echo $selec; ?>&idNota=<?php echo $res_4['id_notas_pro_transversal'];?>&deleta=sim"><img src="../image/deleta.png" width="30" border="0" title="deleta nota" /></a></td>
    <?php }} ?>
  </tr>
</table>
</form>
...
//  }
 ...
 $sql_3 = "INSERT INTO notas_pro_transversal (code, bimestre, id_disciplina, nota, id_atividade,ano_letivo) VALUES ('$code_aluno', '$bimestre', '$disciplina', '$nota', $id,'$date')";
