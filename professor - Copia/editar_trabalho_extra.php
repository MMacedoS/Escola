...
$sql_4 = "UPDATE mural_aluno set date='$date',curso='$curso', titulo='Trabalho extra da disciplina $dis com encerramento no dia $encerramento - Para ver mais detalhes vá em AVALIAÇÕES' WHERE id = '$id' AND professor = '$code')";
...
<table width="700" border="0">
  ...
  <tr>
    ...
    <td><input type="date" name="encerramento" value="<?php echo $res_1['data_entrega'];?>"></td>
