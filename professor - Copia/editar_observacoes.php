...
$sql_5 = "SELECT * FROM atividade_complementar WHERE id = '$id'";
...
$sql_3 = "UPDATE atividade_complementar SET curso='$curso',disciplina = '$dis', detalhes = '$detalhes', bimestre = '$bimestre', data_aplicacao = '$aplicacao' WHERE id = '$id' ";
mysqli_query($conexao, $sql_3);
$sql_4 = "UPDATE mural_aluno (date, curso, titulo,origem) VALUES ('$date','$curso', 'As notas das atividades bimestrais estão sendo divulgadas','Minhas Notas')";
