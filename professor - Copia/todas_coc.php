...
<br /><a class="a3" rel="stylesheet" href="todas_coc.php?pg=coc&selec=<?php echo $selec; ?>&code=<?php echo $code;?>">Atualizar Pagina</a>
</div>
...
$(document).ready(function(){
 ...
 <h1>Abaixo, segue o histórico bimestral da  <strong>avaliação Nacional do COC</strong> de suas turmas!</h1>
