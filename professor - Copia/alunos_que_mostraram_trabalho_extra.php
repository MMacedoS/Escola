...
<table width="955" border="0">
  ...
  <input type="hidden" name="bimestre" value="<?php echo $res_1['aluno']; ?>" />
   ...
   <td><a href="alterar_nota_trabalho.php?pg=trabalho_extra&id=<?php echo $res_1['id']; ?>&id_trabalho=<?php echo $_GET['id']; ?>&aluno=<?php echo $res_1['aluno']; ?>&disciplina=<?php echo $res_1['disciplina']; ?>&nota=<?php echo $res_1['nota']; ?>" rel="superbox[iframe][400x100]"><img border="0" src="../image/ico-editar.png" title="Alterar a nota deste trabalho" /></a></td>
   <?php } ?>
  </tr>
</table>
</form>
