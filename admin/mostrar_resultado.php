...
<?php } ?>
<?php
$sql_2 = mysqli_query($conexao, "SELECT * FROM disciplinas WHERE id_professores = '$q'");
?>
<table width="750" border="0">
  <tr>
...
<?php
$q = $_GET['q'];
$sql_1 = mysqli_query($conexao, "SELECT * FROM estudantes WHERE matricula = '$q'");
	while($res_1 = mysqli_fetch_assoc($sql_1)){
?>
<table width="750" border="0">
  <tr>
...
<table width="750" border="0">
  ...
  <tr>
    <td>
    <?php
    $sql_2 = mysqli_query($conexao, "SELECT * FROM chamadas_em_sala WHERE matricula = '$q' and ano_letivo='$ano' AND presente = 'SIM'");
		while($res_2 = mysqli_fetch_assoc($sql_2)){
				echo $res_2['date_day'];
				echo " - ";
				echo $res_2['id_disciplinas'];		
				echo "<br>";		
    ...
    <td colspan="2">
    <?php
    $sql_3 = mysqli_query($conexao, "SELECT * FROM chamadas_em_sala WHERE matricula = '$q' and ano_letivo='$ano' and presente = 'FALTA'");
		while($res_3 = mysqli_fetch_assoc($sql_3)){
				echo $res_3['date_day'];
				echo " - ";
				echo $res_3['id_disciplinas'];	
				echo "<br>";		
			}
	?>    
    </td>
    <td colspan="2">
    <?php
    $sql_3 = mysqli_query($conexao, "SELECT * FROM chamadas_em_sala WHERE matricula = '$q' and ano_letivo='$ano' AND presente = 'JUSTIFICADA'");
		while($res_3 = mysqli_fetch_assoc($sql_3)){
				echo $res_3['date_day'];
				echo " - ";
				echo $res_3['id_disciplinas'];	
  ...
  <?php } ?>
  <tr>
    <td colspan="6"><h2><strong>Notas bimestrais</strong></h2></td>
  </tr>
  <tr>
 ...
 ?> 
  <tr>
    ...
    <td>
    <?php
     $sql_4 = mysqli_query($conexao, "SELECT * FROM notas_bimestres WHERE bimestre = '2' AND id_disciplinas = '$disciplina' AND code = '$q'");			
    ...
    <td>
    <?php
     $sql_4 = mysqli_query($conexao, "SELECT * FROM notas_bimestres WHERE bimestre = '3' AND id_disciplinas = '$disciplina' AND code = '$q'");			
    ...
    <td>
    <?php
     $sql_4 = mysqli_query($conexao, "SELECT * FROM notas_bimestres WHERE bimestre = '4' AND id_disciplinas = '$disciplina' AND code = '$q'");			
    ...
    <td>
    <?php
     $sql_4 = mysqli_query($conexao, "SELECT * FROM resultado_final WHERE ano_letivo='$ano' AND id_disciplinas = '$disciplina' AND code = '$q'");			
  ...
  <tr>
  <td><?php  $sql_4 = mysqli_query($conexao, "SELECT * FROM resultado_final WHERE ano_letivo='$ano' AND code = '$q' limit 1");			
	 
   while($res_4 = mysqli_fetch_assoc($sql_4)){
      if($res_4['situacao']=="aguardando resultado"){
        ?> <button type="submit" class="btn btn-sucess" onclick="alert('Falta colocar o formulario do conselho');">Conselho</button>
        <?php
      }} ?></td>
  </tr>
  <tr>
