...
$sql_1 = "SELECT * FROM central_mensagem WHERE id='$id' and receptor='COORDENAÇÃO'";}
...
$sql_4 = "INSERT INTO central_mensagem (date, status, emissor, receptor, mensagem, anexo) VALUES ('$date', 'Aguarde resposta', 'COORDENAÇÃO', '$setor', '$mensagem', '$anexo')";
