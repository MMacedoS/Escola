...
?>
   <table class="users" id="table-responsive" border="0">
      <tr>
        ...
        <td class="row-2 row-cur"><strong>Nome:</strong></td>
        <td class="row-3 row-ID"><strong>Profissão:</strong></td>
        <td class="row-4 row-ID"><strong>Remuneração:</strong></td>
        <td class="row-5 row-ID"><strong>Status:</strong></td>
        <td class="row-6 row-ID"></td>
      </tr>
      ...
      <tr>
        ...
        <a class="a" href="funcionarios.php?pg=todos&func=inativa&id=<?php echo $res_1['id']; ?>&code=<?php echo $res_1['code']; ?>"><img title="Inativar funcionário(a)" src="../image/ico_bloqueado.png" width="18" height="18" border="0">		</a>
        <?php } ?>
        <a class="a" href="funcionarios.php?pg=todos&func=edita&id=<?php echo $res_1['id']; ?>"><img title="Editar Dados Cadastrais" src="../image/ico-editar.png" width="18" height="18" border="0"></a>
</td>
      </tr>
      <?php } ?>
    </table>
...
$acesso  = $_POST['acesso'];
$login = str_replace(' ','',$_POST['login'])."@funcionario.ist";
...
mysqli_query($conexao, "INSERT INTO login (status, code, senha, nome, painel) VALUES ('Ativo', '$code', '$cpf', '$login', '$acesso')");	
}
...
<form name="form1" method="post" action="">
  <table class="users" id="table-responsive" border="0">
    ...
    <td><label for="textfield2"></label>
      <input type="text" name="login" id="textfield2"></td>
      <td><label for="textfield2"></label>
    ...
    <tr>
      ...
      <td><select name="acesso" size="1">
        ...
        <option value="coodenacao">Coordenação</option>
      </select></td>
    </tr>
    <tr>
